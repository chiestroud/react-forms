...
const PrivateRoute = ({ component: Component, user, ...rest }) => {
  ...
  const routeChecker = (taco) => (user
    ...
    : (<Redirect to={{ pathname: '/not-found', state: { from: taco.location } }} />));
...
// You can create different route for student/admin anything you want
// const StudentRoute = ({ component: Component, user, ...rest }) => {
//   // when we call this function in the return, it is looking for an argument. `props` here is taco.
//   const routeChecker = (taco) => (user.isStudent
//     ? (<Component {...taco} user={user} />)
